...
import com.mycompany.ProductoFacadeLocal;
...
public class ProductoController implements Serializable {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("classes/Bundle").getString("ProductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("classes/Bundle").getString("ProductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("classes/Bundle").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
